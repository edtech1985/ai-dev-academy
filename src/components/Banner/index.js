    ...
    <SectionContainer id="section1">
      ...
      <DivText>
        <Text1>
          ...
          está transformando a maneira como você aprende e domina a tecnologia
          do amanhã.
        </Text1>
        <br />
        <Text1>
          ...
          personalizáveis, incluindo modelos de renome como Morgan Freeman, Bill
          Gates e Elon Musk, você tem o controle total sobre como e o que
          aprender.
        </Text1>
        <br />
        <Text1>
          Prepare-se para explorar um mundo de possibilidades e moldar seu
          próprio caminho na IA e no desenvolvimento. O futuro começa aqui, na
          AI Dev Academy!
        </Text1>
      </DivText>
